...
class AutoEstimate {
  ...
  @observable CNCMaterialOption= [
    ...
    { id: 8, name: "구리 260(황동)" },
    { id: 9, name: "구리 C110" },
    { id: 10, name: "구리 C360(황동)"},
    { id: 11, name: "구리 C932(청동)"},
    { id: 12, name: "플라스틱(ABS/PP/PC/PVC)" },
    { id: 13, name: "아크릴" },
    { id: 14, name: "아세틸/나일론" },
    { id: 15, name: "스테인리스 15-5"},
    { id: 16, name: "스테인리스 17-4"},
    { id: 17, name: "스테인리스 303" },
    { id: 18, name: "스테인리스 304" },
    { id: 19, name: "스테인리스 316" },
    { id: 20, name: "스테인리스 410"},
    { id: 21, name: "스테인리스 416"},
    { id: 22, name: "스테인리스 420"},
    { id: 23, name: "스테인리스 440"},
    { id: 24, name: "철 1018"},
    { id: 25, name: "철 1215"},
    { id: 26, name: "철 4130"},
    { id: 27, name: "철 4140"},
