...
class Partner {
  ...
  @action getRequestByProjectId = (projectId) => {
    if (projectId == -1) {
      return;
    }
 ...
 */
  ...
  */
  ...
  // Reply QnA POST
  @action replyQuestion = async (questionID, state, content) => {
    const formData = new FormData();
    ...
    await PartnerAPI.replyQuestion(req)
      .then((res) => {
        console.log(res);
        alert("글 작성이 완료되었습니다");
      })
  ...
  @action getQuestion = (partnerID) => {
    ...
    PartnerAPI.getQuestion(req).then((res) => {
      console.log(res);
    });
  };

  // Reply QnA GET
  @action getReplyQuestion = (questionID) => {
    const formData = new FormData();
    ...
    PartnerAPI.getReplyQuestion(req).then((res) => {
      console.log(res);
    });
  };
  // =======================================================================
