                ...
                <Containerv1 style={{ flexDirection: 'column' }}>
                    <CompleteInfoTitle>
                        ...
                        <CompleteInfoDesc style={{ display: 'block', marginTop: '20px' }}>
                            ...
                            <br />
                            <FontSize32 style={{ color: '#282c36' }}>
                                배정된 프로젝트 매니저가 검토 후 1영업일 내로 연락드립니다.
                            </FontSize32>
                        </CompleteInfoDesc>
                    </CompleteInfoTitle>
                            ...
                            <CompleteInfoLeft>
                                ...
                                <InlineFlexDiv
                                    style={{
                                        marginTop: '154px',
                                        marginBottom: '10px',
                                        borderBottom: `1px solid #c6c7cc`,
                                    }}
                                >
                                    <FontSize20 style={{ marginBottom: '12px' }}>배송지정보</FontSize20>
                                    <FontSize18
                                        style={{ color: '#414550', fontWeight: 'normal', marginBottom: '12px' }}
                                    >
                            ...
                            <CompleteInfoRight>
                                <InlineFlexDiv style={{ marginTop: '76px', borderBottom: `1px solid #c6c7cc` }}>
                                    ...
                                    <FontSize18 style={{ marginBottom: '12px' }}>
                                        {(Math.round((AutoEstimate.totalPrice * 1.1) / 1000) * 1000).toLocaleString(
                                            'ko-KR'
                                        )}{' '}
                                        원(VAT 포함)
                                    </FontSize18>
                                ...
                                <InlineFlexDiv>
                                    <FontSize18 style={{ color: '#767676', fontWeight: 'normal', marginTop: '10px' }}>
                                        부품가격
                                    </FontSize18>
                                    <FontSize18 style={{ color: '#414550', marginTop: '10px' }}>
                                        {(Math.round(AutoEstimate.totalPrice / 1000) * 1000).toLocaleString('ko-KR')}원
                                    </FontSize18>
                                </InlineFlexDiv>
                                <InlineFlexDiv>
                                    <FontSize18 style={{ color: '#767676', fontWeight: 'normal', marginTop: '12px' }}>
                                        배송비
                                    </FontSize18>
                                ...
                                {/* <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '10px' }}>
                                    <FontSize18 style={{ color: '#767676', fontWeight: 'normal' }}>
                                        도착 예정일 : 검수완료 후 1영업일 이내
                                    </FontSize18>
                                </div> */}
                            </CompleteInfoRight>
                        </CompleteInfoBox>
                    ...
                    >
                        <CompleteBtn onClick={() => window.open('https://www.boltnnut.com/search')}>
                            <FontSize20 style={{ color: '#0933b3', fontWeight: 'bold', textAlign: 'center' }}>
                                제조사 찾아보기
                            </FontSize20>
                        </CompleteBtn>
                        ...
                        <CompleteBtn
                            onClick={() => Router.push('/')}
                            style={{ backgroundColor: '#0933b3', marginLeft: '22px' }}
                        >
                            <FontSize20 style={{ color: '#ffffff', fontWeight: 'bold', textAlign: 'center' }}>
                                홈으로가기
                            </FontSize20>
                        </CompleteBtn>
                    </div>
