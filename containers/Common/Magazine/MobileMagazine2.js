...
class MobileContentContainer extends React.Component {
  ...
  categoryClickHandler = (item, idx) => {
    ...
    if (Magazine.mobile_category_checked_idx !== idx) {
      if (
        Magazine.mobileUpperCategoryAry[Magazine.mobile_category_checked_idx]
          .item[Magazine.mobile_category_detail_checked_idx]
      ) {
        Magazine.mobileUpperCategoryAry[
          Magazine.mobile_category_checked_idx
        ].item[Magazine.mobile_category_detail_checked_idx].checked = false;
        Magazine.mobileUpperCategoryAry[
          Magazine.mobile_category_checked_idx
        ].item[0].checked = true;
  ...
  lowerCategoryClickHandler = (data, idx, id) => {
    ...
    if (Magazine.mobile_category_detail_checked_idx !== id) {
      data.checked = true;
      Magazine.mobileUpperCategoryAry[idx].item[
        Magazine.mobile_category_detail_checked_idx
      ].checked = false;
  ...
  nextPage = () => {
    ...
    Magazine.mobile_full_page =
      parseInt(this.props.Magazine.magazine_list.length / 6) + 1;
      ...
      <>
          ...
          <div>
            {Magazine.mobileUpperCategoryAry.map((item, idx) => {
              return (
                <UpperItem
                  onClick={() => {
                    this.categoryClickHandler(item, idx);
                  }}
                  checkUpperMenu={item.checked}
                  checkBoxShadow={item}
                >
                  <span>{item.name}</span>
                </UpperItem>
                ...
                item.item.map((data, id) => {
                  return (
                    <LowerItem
                      ...
                      checkBoxShadow={item}
                      onClick={() => {
                        this.lowerCategoryClickHandler(data, idx, id);
                      }}
                    >
                      <span>{data.name}</span>
                    </LowerItem>
        ...
        <Row checked={Magazine.checked}>
          {this.props.Magazine.magazine_list
            .slice((Magazine.current_page - 1) * 6, Magazine.current_page * 6)
            .map((item, idx) => {
              return (
                <>
                  {item && (
        ...
        <PageBar>
          <img
            src={left}
            style={{
              opacity: current_set == 1 && Magazine.current_page <= 1 ? 0.4 : 1,
              cursor: "pointer",
            }}
          ...
          <PageCount
            ...
            style={{
              display:
                Magazine.mobile_full_page < 5 * (current_set - 1) + 1
                  ? "none"
                  : "block",
            }}
          ...
          <PageCount
            ...
            style={{
              display:
                Magazine.mobile_full_page < 5 * (current_set - 1) + 2
                  ? "none"
                  : "block",
            }}
            onClick={this.movePage}
          ...
          <PageCount
            ...
            style={{
              display:
                Magazine.mobile_full_page < 5 * (current_set - 1) + 3
                  ? "none"
                  : "block",
            }}
            onClick={this.movePage}
          ...
          <PageCount
            ...
            style={{
              display:
                Magazine.mobile_full_page < 5 * (current_set - 1) + 4
                  ? "none"
                  : "block",
            }}
            onClick={this.movePage}
          ...
          <PageCount
            ...
            style={{
              display:
                Magazine.mobile_full_page < 5 * (current_set - 1) + 5
                  ? "none"
                  : "block",
            }}
            onClick={this.movePage}
          ...
          <img
            ...
            style={{
              opacity:
                Magazine.current_page == Magazine.mobile_full_page ? 0.4 : 1,
            }}
          />
        </PageBar>
      </>
...
const LowerItem = styled.div`
  ...
  > span {
    //font-weight: ${(props) =>
      props.checkLowerMenu.checked ? "bold" : "normal"};
    color: ${(props) => (props.checkLowerMenu.checked ? "#0933b3" : "#a4aab4")};
    border-bottom: ${(props) =>
      props.checkLowerMenu.checked ? "3px solid #0933b3" : ""};
