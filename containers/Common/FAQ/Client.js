    ...
    contents: [
      {
        ...
        open: true,
        question:
          "1. 프로젝트를 의뢰하려면 클라이언트/파트너 중 어떤 유형으로 가입해야 하나요?",
        answer:
          "'클라이언트'와 '파트너' 각 계정을 따로 가입해 활동할 수 있습니다." +
      ...
      },
      {
        ...
        answer:
          "▶의뢰서 작성 – 자동 견적 제공 – 전문 컨설턴트와 상세 상담 – 프로젝트 정식 견적서 제공  – 계약 진행 시 프로세스 안내 – 개발/생산 및 납품" +
      ...
      },
      {
        ...
        answer:
          "클라이언트와 파트너 모두 이용요금을 별도로 부과하고 있지는 않습니다.\n" +
      ...
      },
      {
        ...
        answer:
          "무료로 견적 받기 버튼을 눌러 의뢰서를 작성해주세요. 짧은 질문을 통해 견적을 안내드립니다. 정확한 견적을 위한 무료 상담과 생산을 위한 무료 도면 서비스도 이용하실 수 있습니다.",
      },
      {
        id: 5,
        open: false,
        question:
          "5. 프로젝트 내용이 외부로 유출되면 안되는 경우에는 어떻게 하나요?",
        answer:
          "프로젝트의 내용은 외부로 공개되지 않습니다. NDA 등을 작성을 원하시면 상담 신청을 통해 작성이 가능합니다",
      },
      {
        id: 6,
        open: false,
        ...
        answer:
          "볼트앤너트에서 진행한 프로젝트는 사이트 상단의 [프로젝트목록]에서 확인하실 수 있습니다. 해당 프로젝트에서 리뷰를 작성해보세요. \n",
      },
      {
        id: 7,
        open: false,
      ...
      },
      {
        ...
        open: false,
        question:
          "8. 프로젝트의 예상 기간, 지출 가능 예산을 작성하기 어렵습니다.",
        answer:
          "희망 비용과 기간의 경우 원하시는 기간을 자유롭게 작성하시면 됩니다.",
      },
      {
        id: 9,
        open: false,
        ...
        answer:
          "모두 가능하나 의뢰서를 작성해주시는 것이 더욱 정확한 상담을 도와드릴 수 있습니다.",
      },
      {
        id: 10,
        open: false,
        ...
        answer:
          "아닙니다. 등록해주신 자료들은 프로젝트 관리에만 활용되는 자료일 뿐 따로 외부에 공개되지는 않습니다.",
      },
      {
        id: 11,
        open: false,
        ...
        answer:
          "계약 이전이라면 담당 컨설턴트, 계약 이후라면 배정된 담당 PM 분과 협의하여 계약 진행 시기를 조율할 수 있습니다. ",
      },
      {
        id: 12,
        open: false,
        ...
        answer:
          "네. 견적은 작성해주신 기본 정보를 바탕으로 도출되는 것으로 미팅 시 세부사항에 따라 금액과 기간이 달라질 수 있습니다.",
      },
      {
        id: 13,
        open: false,
        ...
        answer:
          "무료 상담 시에는 정확한 견적 도출 및 해당 프로젝트 진행 프로세스에 대해 안내드립니다.\n" +
      ...
      },
      {
        ...
        answer:
          "발생하지 않습니다. 볼트앤너트를 이용할 시 클라이언트께서 따로 내시는 이용요금은 없습니다.",
      },
      {
        id: 16,
        open: false,
        ...
        answer:
          "온라인 상에서 상담 취소는 어려우며, 볼트앤너트 홈페이지 하단의 전화번호 혹은 이메일로 따로 연락을 주시면 해결해드립니다.",
      },
      {
        id: 17,
        open: false,
      ...
      },
      {
        ...
        open: false,
        question:
          "18. 프로젝트 진행 도중 계약 내용을 변경해야 할 경우 어떻게 해야 하나요?",
