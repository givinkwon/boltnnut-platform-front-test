    ...
    contents: [
      {
        ...
        answer:
          "제조 프로젝트를 의뢰하는 주체를 '클라이언트', 볼트앤너트가 관리하는 프로젝트 개발/생산에 관여하는 제조사를 '파트너'라고 칭합니다.",
      },
      {
        id: 2,
        open: false,
      ...
      },
      {
        ...
        open: false,
        question:
          "3. 클라이언트, 파트너 계정 아이디를 동일하게 사용할 수는 없나요?",
        answer:
          "네, 그렇습니다. 클라이언트와 파트너를 동시에 이용하고 싶으신 경우 둘 다 가입해주셔야 합니다.",
      },
      {
        id: 4,
        open: false,
        question:
          "4. 계정 정보(휴대폰 번호, 주소지, 프로필 이미지 등)을 변경하고 싶어요.",
