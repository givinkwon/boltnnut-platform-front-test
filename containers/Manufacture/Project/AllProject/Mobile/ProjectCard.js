...
class ProjectCardContainer extends React.Component {
  ...
  render() {
    ...
    return (
      <Background style={{ marginTop: 16, marginBottom: 0, width: "100%" }}>
        <Container style={{ marginBottom : 24, marginTop : 24, width: "100%" }}>
          <MainContainer>
            <ContentBox style={{ width: 110}}>
              <Title12>{data.status}</Title12>
              <img src="/static/images/new.svg" />
            </ContentBox>

            <ContentBox style={{ width: "100%", marginTop: 20 }}>
              <Title16 style={{width : "100%"}}>
                {name && name.length > 15 ? name.slice(0, 15) + "..." : name}
              </Title16>
              <Title12 style={{ color: "#767676", marginLeft : "auto"}}>{date}</Title12>
            </ContentBox>

            <ContentBox style={{ justifyContent: "center", marginTop: 25, gap : 40}}>
              <ImgInnerBox>
                <InnerBox>
                  <img src="static/images/class.svg" />
                  <Title12 style={{ color: "#767676"}}>업체분류</Title12>
                </InnerBox>
              ...
              <ImgInnerBox>
                <InnerBox>
                  ...
                  <Title12 style={{ color: "#767676"}}>문의목적</Title12>
                </InnerBox>
              ...
              <ImgInnerBox>
                <InnerBox>
                  ...
                  <Title12 style={{ color: "#767676"}}>예상금액</Title12>
                </InnerBox>
