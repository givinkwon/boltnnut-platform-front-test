...
@inject("Partner", "Auth", "Answer", "Search")
@observer
class PortfolioConatiner extends React.Component {
  ...
  render() {
    const { Answer, file, Partner, width, Search } = this.props;
    var settings = {
      dots: false,
      infinite: false,
      arrows: false,
        ...
        >
          <Content>
            ...
            {Partner.portFolioList && Partner.portFolioList.length > 0 && (
              <>
                <Arrow left onClick={Search.sliderPrev} />
                <Arrow right onClick={Search.sliderNext} />
              </>
            )}
          </Content>
