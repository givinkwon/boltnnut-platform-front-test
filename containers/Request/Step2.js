...
//  };
  ...
  render() {
    ...
    return (
      <div>
        <HeaderContainer>
        {Request.type==="manufacturer" &&<Text.FontSize24 color={'#0933b3'} fontWeight={500}>제조사 찾기 서비스</Text.FontSize24>}
        {Request.type==="massproduct" &&<Text.FontSize24 color={'#0933b3'} fontWeight={500}>양산개발 서비스</Text.FontSize24>}
        {Request.type==="estimate" &&<Text.FontSize24 color={'#0933b3'} fontWeight={500}>견적수량 도출 서비스</Text.FontSize24>}
