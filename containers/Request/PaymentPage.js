			...
			<Background>
				<PaymentPageDiv>
					<PaymentPageLeft>
						...
						<PaymentWayBox>
							<PaymentWay onClick={() => this.paymentWayClick(1)} active={activeHandler(1)}>
								<PaymentCheckImg src={passimg} active={activeHandler(1)} />
								<PaymentWayTitle>신용카드</PaymentWayTitle>
							</PaymentWay>
							<PaymentWay onClick={() => this.paymentWayClick(2)} active={activeHandler(2)}>
								<PaymentCheckImg src={passimg} active={activeHandler(2)} />
								<PaymentWayTitle>실시간 계좌이체</PaymentWayTitle>
							</PaymentWay>
							<PaymentWay onClick={() => this.paymentWayClick(3)} active={activeHandler(3)}>
					...
					<PaymentPageRight>
						<PaymentInfoWrap>
							...
							<PaymentInfo2>
								<InlineFlexDiv style={{ justifyContent: 'space-between', marginTop: '30px' }}>
									<FontSize18 style={{ color: '#767676', marginBottom: '20px' }}>부품 갯수</FontSize18>
									<FontSize18 style={{ color: '#414550', fontWeight: '500' }}>3개</FontSize18>
								</InlineFlexDiv>
								<InlineFlexDiv style={{ justifyContent: 'space-between' }}>
