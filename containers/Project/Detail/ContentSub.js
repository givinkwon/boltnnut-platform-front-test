...
class ContentSub extends React.Component{
    render(){
        return(
            <ContainerSub>
					<Box3 style = {{ marginBottom: 20}}><Font18 style = {{color: '#ffffff', fontWeight: 'bold' }}  >프로젝트 지원하기</Font18></Box3>
					<Box3 style = {{backgroundColor: '#ffffff'}}><Font18 style = {{ color: '#0933b3', fontWeight: 'bold'}}>관심 프로젝트 등록</Font18></Box3>
