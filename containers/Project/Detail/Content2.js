...
class Content2 extends React.Component {
  ...
  Cell = [{Content: "지원한 파트너"}, {Content: "선정된 파트너"}, {Content:"프로젝트 지원/취소 안내"}];  
      ...
      <div style = {{marginTop: 100, marginBottom: 100}}>
        <Container2Select>
          {this.Cell.map((cell, idx) => 
            <SelectContainer active = {this.activeHandler(idx)} onClick = {() => this.cellChecked(idx)}>
        ...
        <Container2Body>
          ...
          <div><Font22 style={{ fontWeight: 'bold' }}>지원한 파트너</Font22><Font24 style={{ marginLeft: 6, color: "#0933b3" }}>3</Font24></div>
          <PartnerCategory>
            <div>
              <div>
              ...
              <div>
                <Font15 style={{ marginRight: 10 }}>2021.02.16</Font15><Font15>18:00</Font15>
              </div>
            </div>
        ...
        ):   (check==1)   ? <Container2Body></Container2Body>: <Container2Body/>}
      </div>
