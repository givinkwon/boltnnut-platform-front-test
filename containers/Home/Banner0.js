...
const BARO_OFFICE = '/static/images/BARO_OFFICE.svg';
            ...
            >
                <Containerv1 style={{ gap: 30, alignItems: 'center' }}>
                    <LeftBox>
                        <GridDiv>
                            <Col_1>
                                <Header>CNC 가공 빠르고, 안전하게</Header>
                                <Header2>
                                    <span>AI 견적</span>으로<br></br>제조 부품 <span>바로발주</span>
                                </Header2>
                                <Desc>
                                    3D 도면만 올리면 부품 납기, 견적이 바로!<br></br>
                                    즉시 견적 확인하고 편하게 발주하세요.
                                </Desc>
                            </Col_1>
                            <Col_2>
                                <Img_Office src={BARO_OFFICE}></Img_Office>
                            </Col_2>
                        </GridDiv>
                        <this.MyDropzone />
                    </LeftBox>
                    {/* <video
                        style={{
                            borderRadius: 10,
                            boxShadow: '4px 5px 20px 0 rgba(0, 0, 0, 0.16)',
                            width: '700px',
                            height: '700px',
                            marginTop: 40,
                        }}
