  ...
  state = {
    contents: [
      ...
      },
      {
        ...
        answer: "▶의뢰서 작성 – 자동 가견적 제공 – 전문 컨설턴트와 상세 상담 – 프로젝트 정식 견적서 제공  – 계약 진행 시 프로세스 안내 – 개발/생산 및 납품" +
          "① 클라이언트께서 의뢰서를 작성해주시면 볼트앤너트 AI 알고리즘이 바로 가견적을 안내해드립니다. \n" +
          "② 가견적을 확인 후에 정확한 견적을 알고 싶다면 볼트앤너트 전문 컨설턴트에게 무료 상담을 받아보세요\n" +
      ...
      },
      {
        ...
        answer: "무료로 가견적 받기 버튼을 눌러 의뢰서를 작성해주세요. 짧은 질문을 통해 가견적을 안내드립니다. 정확한 가견적을 위한 무료 상담과 생산을 위한 무료 도면 서비스도 이용하실 수 있습니다."
      },
      {
        id: 5,
        open: false,
      ...
      },
      {
        ...
        answer: "네. 가견적은 작성해주신 기본 정보를 바탕으로 도출되는 것으로 미팅 시 세부사항에 따라 금액과 기간이 달라질 수 있습니다."
      },
      {
        id: 13,
        open: false,
